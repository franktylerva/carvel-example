...
# Lesson learned:  Ordering Helm charts can work against the ordering kapp does.
...
#     -f <(kubectl create ns atlas-orbital-crud-service --dry-run=client -o yaml) \
#     -f <(kubectl create ns atlas-sensor-crud-service --dry-run=client -o yaml) \
